    ...
    <el-dialog title="创建组" :data="adminuser" :visible.sync="statusDialogCVisible">
      <el-form>
        ...
        <el-form-item label="组描述" :label-width="formLabelWidth">
          <el-input v-model="inputgd" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="编辑组" :data="admgroup" :visible.sync="statusDialogEVisible">
      <el-form>
        ...
        <el-form-item label="编辑描述" :label-width="formLabelWidth">
          <el-input v-model="inputegd" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
      ...
      <el-table :data="tuser" style="width: 100%">
        ...
        <el-table-column label="权限" width="120">
          <template slot-scope="scoped">
            ...
            <el-tag v-else-if="scoped.row.role === 2" type="success">管理员</el-tag>
            <el-tag v-else-if="scoped.row.role === 3" type="danger">超级管理员</el-tag>
          </template>
        </el-table-column>
