<template>
  <div>
    ...
    <el-table :data="tableData.slice((page - 1) * pagesize, page * pagesize)" style="width: 100%">
      ...
      <el-table-column label="处理器配置" width="100">
        <template slot-scope="scope">
          <!-- <i class='el-icon-time'></i> -->
          <span>{{ scope.row.used_cpu }}/{{ scope.row.cpu }}</span>
        </template>
      </el-table-column>
      <el-table-column label="内存配置" width="100">
        <template slot-scope="scope">
          <!-- <i class='el-icon-time'></i> -->
      ...
      <el-table-column label="Pod管理" type="expand" width="60">
        <template slot-scope="scope">
          <el-table :data="scope.row.pod_list">
            <el-table-column label="Pod编号" width="60" type="index" />
